...
//            systemMessage.put("content", "You are an AI assistant that helps people plan their schedules given the tasks and calendar events for the day. " +
//                    "Tasks with the lowest priority number should be given more importance. " +
//                    "Understand the title of the tasks and estimate the time needed to finish it. " +
//                    "Additionally, take into account the due dates of tasks and allocate appropriate time slots accordingly. " +
//                    "For tasks approaching their due dates, assign a time duration based on the percentage of completion, ensuring timely completion. " +
//                    "Make sure that allotted time for the tasks don't clash with any scheduled events and don't change the start and end time given in 24hrs format for any of the events. " +
//                    "Suggest and provide a more detailed and structured timetable for the day to maximize productivity. Keep a few hours free for breaks, lunch etc. \n" +
//                    "Desired format:\n" +
//                    "\"9:00 - 10:00: Task/Event\" \n");
//
...
//            jsonObject.put("messages", messages);
    ...
    public String formatUserContent(@NonNull List<TaskPlanner> tasks, @NonNull List<CalendarEvent> events){
        ...
        op+="\nNow, plan my day based on the available tasks and calendar events.";
        return op;
    }
}
